...
function getLocalIdent(context, localIdentName, localName, options) {
  ...
  const className = loaderUtils.interpolateName(context, localName, options); // для быстрого перехода и кому не нужны модули

  // const className = loaderUtils.interpolateName(context, hash, options); // для проекта
